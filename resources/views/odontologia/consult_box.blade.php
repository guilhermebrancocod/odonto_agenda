...
">
                <div class="input-group" style="flex:1 1 320px; min-width:260px; flex-direction:column;">
                    <label for="selectBoxes" style="display:block; font-size:12px; color:#6b7280; margin-bottom:6px;">
                        Box
                    </label>
                    <div class="form-outline">
                        <select id="selectBoxes" name="selectBoxes"
             ...
             font-size:14px; font-weight:500; border-radius:8px; cursor:pointer;">
                    ...
                    <button type="submit" id="add" title="Adicionar box"
                        style="display:inline-flex; align-items:center; justify-content:center; gap:8px;
